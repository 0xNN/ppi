...
class JenisOperasiController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('jenis-operasi.admin.index');
    }
    ...
    public function store(Request $request)
    {
        ...
        $post = JenisOperasi::updateOrCreate(['id' => $id],[
            'nama_jenis_operasi' => $request->nama_jenis_operasi
        ]);
     ...
     *
     * @param  \App\Models\JenisOperasi  $jenisOperasi
     * @return \Illuminate\Http\Response
     */
    public function show(JenisOperasi $jenisOperasi)
    {
        //
    }
    ...
    {
        $where = array('id' => $id);
        $post  = JenisOperasi::where($where)->first();
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(Request $request, JenisOperasi $jenisOperasi)
    {
        //
    }
    ...
    {
        $where = array('id' => $id);
        $post = JenisOperasi::where($where)->delete();
        return response()->json($post);
    }
}
