...
class RiskScoreController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('risk-score.admin.index');
    }
    ...
    public function store(Request $request)
    {
        ...
        $post = RiskScore::updateOrCreate(['id' => $id],[
            'nama_risk_score' => $request->nama_risk_score
        ]);
     ...
     *
     * @param  \App\Models\RiskScore  $riskScore
     * @return \Illuminate\Http\Response
     */
    ...
    {
        $where = array('id' => $id);
        $post  = RiskScore::where($where)->first();
    ...
    {
        $where = array('id' => $id);
        $post = RiskScore::where($where)->delete();
        return response()->json($post);
    }
}
