...
class TindakanOperasiController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('tindakan-operasi.admin.index');
    }
    ...
    public function store(Request $request)
    {
        ...
        $post = TindakanOperasi::updateOrCreate(['id' => $id],[
     ...
     *
     * @param  \App\Models\TindakanOperasi  $tindakanOperasi
     * @return \Illuminate\Http\Response
     */
    public function show(TindakanOperasi $tindakanOperasi)
    {
        //
    }
    ...
    {
        $where = array('id' => $id);
        $post  = TindakanOperasi::where($where)->first();
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(Request $request, TindakanOperasi $tindakanOperasi)
    {
        //
    }
    ...
    {
        $where = array('id' => $id);
        $post = TindakanOperasi::where($where)->delete();
        return response()->json($post);
    }
}
