@extends('layouts.app', ['title' => __('Ruang')])

@section('content')
  @include('header.partials.header', [
      'title' => __('Ruang'),
      'description' => __('Data Ruang'),
      'class' => 'col-lg-12'
      ])

  @include('ruang.admin.modal')
  <div class="container-fluid mt--7">
    <div class="row">
        <div class="col-xl-12 order-xl-1">
            <div class="card bg-secondary shadow">
                <div class="card-header bg-white border-0">
                    <div class="text-danger font-italic">{{ __('List Ruang!') }}</div>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="dt-ruang" class="table table-sm table-bordered dt-responsive nowrap" style="width:100%">
...
<script>
    ...
    $(document).ready(function() {
        var table = $('#dt-ruang').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: "{{ route('master.ruang.r-ruang.index') }}",
            columns: [
            ...
            $("#form-tambah-edit").validate({
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        ...
                        url: "{{ route('master.ruang.r-ruang.store') }}", //url simpan data
                        ...
                        success: function (data) { //jika berhasil
                            ...
                            var oTable = $('#dt-ruang').dataTable(); //inialisasi datatable
        ...
        $('body').on('click', '.edit-post', function () {
            ...
            $.get('r-ruang/'+data_id + '/edit', function (data) {
        ...
        $('#tombol-utama-hapus').click(function () {
            var url = "{{ route('master.ruang.r-ruang.destroy', ":dataId") }}";
