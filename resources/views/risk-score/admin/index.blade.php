@extends('layouts.app', ['title' => __('Risk Score')])

@section('content')
  @include('header.partials.header', [
      'title' => __('Risk Score'),
      'description' => __('Data Risk Score'),
      'class' => 'col-lg-12'
      ])

  @include('risk-score.admin.modal')
  <div class="container-fluid mt--7">
    <div class="row">
        <div class="col-xl-12 order-xl-1">
            <div class="card bg-secondary shadow">
                <div class="card-header bg-white border-0">
                    <div class="text-danger font-italic">{{ __('List Risk Score!') }}</div>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="dt-risk-score" class="table table-sm table-bordered dt-responsive nowrap" style="width:100%">
...
<script>
    ...
    $(document).ready(function() {
        var table = $('#dt-risk-score').DataTable({
            language: {
              language: {
            ...
            processing: true,
            serverSide: true,
            ajax: "{{ route('master.risk-score.r-risk-score.index') }}",
            columns: [
                {data: 'DT_RowIndex', name: 'DT_RowIndex'},
                {data: 'id', name: 'id'},
                {data: 'action', name: 'action', orderable: false, searchable: false},
                {data: 'nama_risk_score', name: 'nama_risk_score'},
            ...
            $("#form-tambah-edit").validate({
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        ...
                        url: "{{ route('master.risk-score.r-risk-score.store') }}", //url simpan data
                        ...
                        success: function (data) { //jika berhasil
                            ...
                            var oTable = $('#dt-risk-score').dataTable(); //inialisasi datatable
        ...
        $('body').on('click', '.edit-post', function () {
            ...
            $.get('r-risk-score/'+data_id + '/edit', function (data) {
                ...
                $('#id').val(data.id);
                $('#nama_risk_score').val(data.nama_risk_score);
            })
        });
        ...
        $('#tombol-utama-hapus').click(function () {
            var url = "{{ route('master.risk-score.r-risk-score.destroy', ":dataId") }}";
            ...
            success: function (data) { //jika sukses
                setTimeout(function () {
                    ...
                    var oTable = $('#dt-risk-score').dataTable();
                    oTable.fnDraw(false); //reset datatable
                });
