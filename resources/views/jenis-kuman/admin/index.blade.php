@extends('layouts.app', ['title' => __('Jenis Kuman')])

@section('content')
  @include('header.partials.header', [
      'title' => __('Jenis Kuman'),
      'description' => __('Data Jenis Kuman'),
      'class' => 'col-lg-12'
      ])

  @include('jenis-kuman.admin.modal')
  <div class="container-fluid mt--7">
    <div class="row">
        <div class="col-xl-12 order-xl-1">
            <div class="card bg-secondary shadow">
                <div class="card-header bg-white border-0">
                    <div class="text-danger font-italic">{{ __('List Jenis Kuman!') }}</div>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="dt-jenis-kuman" class="table table-sm table-bordered dt-responsive nowrap" style="width:100%">
...
<script>
    ...
    $(document).ready(function() {
        var table = $('#dt-jenis-kuman').DataTable({
            language: {
              language: {
            ...
            processing: true,
            serverSide: true,
            ajax: "{{ route('master.jenis-kuman.r-jenis-kuman.index') }}",
            columns: [
                {data: 'DT_RowIndex', name: 'DT_RowIndex'},
                {data: 'id', name: 'id'},
                {data: 'action', name: 'action', orderable: false, searchable: false},
                {data: 'nama_jenis_kumen', name: 'nama_jenis_kumen'},
            ...
            $("#form-tambah-edit").validate({
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        ...
                        url: "{{ route('master.jenis-kuman.r-jenis-kuman.store') }}", //url simpan data
                        ...
                        success: function (data) { //jika berhasil
                            ...
                            var oTable = $('#dt-jenis-kuman').dataTable(); //inialisasi datatable
        ...
        $('body').on('click', '.edit-post', function () {
            ...
            $.get('r-jenis-kuman/'+data_id + '/edit', function (data) {
                ...
                $('#id').val(data.id);
                $('#nama_jenis_kumen').val(data.nama_jenis_kumen);
            })
        });
        ...
        $('#tombol-utama-hapus').click(function () {
            var url = "{{ route('master.jenis-kuman.r-jenis-kuman.destroy', ":dataId") }}";
            ...
            success: function (data) { //jika sukses
                setTimeout(function () {
                    ...
                    var oTable = $('#dt-jenis-kuman').dataTable();
                    oTable.fnDraw(false); //reset datatable
                });
