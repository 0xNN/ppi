@extends('layouts.app', ['title' => __('Lama Operasi')])

@section('content')
  @include('header.partials.header', [
      'title' => __('Lama Operasi'),
      'description' => __('Data Lama Operasi'),
      'class' => 'col-lg-12'
      ])

  @include('lama-operasi.admin.modal')
  <div class="container-fluid mt--7">
    <div class="row">
        <div class="col-xl-12 order-xl-1">
            <div class="card bg-secondary shadow">
                <div class="card-header bg-white border-0">
                    <div class="text-danger font-italic">{{ __('List Lama Operasi!') }}</div>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="dt-lama-operasi" class="table table-sm table-bordered dt-responsive nowrap" style="width:100%">
...
<script>
    ...
    $(document).ready(function() {
        var table = $('#dt-lama-operasi').DataTable({
            language: {
              language: {
            ...
            processing: true,
            serverSide: true,
            ajax: "{{ route('master.lama-operasi.r-lama-operasi.index') }}",
            columns: [
                {data: 'DT_RowIndex', name: 'DT_RowIndex'},
                {data: 'id', name: 'id'},
                {data: 'action', name: 'action', orderable: false, searchable: false},
                {data: 'nama_lama_operasi', name: 'nama_lama_operasi'},
            ...
            $("#form-tambah-edit").validate({
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        ...
                        url: "{{ route('master.lama-operasi.r-lama-operasi.store') }}", //url simpan data
                        ...
                        success: function (data) { //jika berhasil
                            ...
                            var oTable = $('#dt-lama-operasi').dataTable(); //inialisasi datatable
        ...
        $('body').on('click', '.edit-post', function () {
            ...
            $.get('r-lama-operasi/'+data_id + '/edit', function (data) {
                ...
                $('#id').val(data.id);
                $('#nama_lama_operasi').val(data.nama_lama_operasi);
            })
        });
        ...
        $('#tombol-utama-hapus').click(function () {
            var url = "{{ route('master.lama-operasi.r-lama-operasi.destroy', ":dataId") }}";
            ...
            success: function (data) { //jika sukses
                setTimeout(function () {
                    ...
                    var oTable = $('#dt-lama-operasi').dataTable();
                    oTable.fnDraw(false); //reset datatable
                });
