...
@section('content')
  ...
  @include('antibiotik.admin.modal')
  <div class="container-fluid mt--7">
    <div class="row">
        <div class="col-xl-12 order-xl-1">
            <div class="card bg-secondary shadow">
                <div class="card-header bg-white border-0">
                    <div class="text-danger font-italic">{{ __('List Antibiotik!') }}</div>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="dt-antibiotik" class="table table-sm table-bordered dt-responsive nowrap" style="width:100%">
...
<script>
    ...
    $(document).ready(function() {
        var table = $('#dt-antibiotik').DataTable({
            language: {
              language: {
            ...
            processing: true,
            serverSide: true,
            ajax: "{{ route('master.antibiotik.r-antibiotik.index') }}",
            columns: [
                {data: 'DT_RowIndex', name: 'DT_RowIndex'},
                {data: 'id', name: 'id'},
                {data: 'action', name: 'action', orderable: false, searchable: false},
                {data: 'nama_antibiotik', name: 'nama_antibiotik'},
                {data: 'jumlah', name: 'jumlah'},
                {data: 'is_active', name: 'is_active'},
                {data: 'kategori_antibiotik_id', name: 'kategori_antibiotik_id'},
            ...
            $("#form-tambah-edit").validate({
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        ...
                        url: "{{ route('master.antibiotik.r-antibiotik.store') }}", //url simpan data
                        ...
                        success: function (data) { //jika berhasil
                            ...
                            var oTable = $('#dt-antibiotik').dataTable(); //inialisasi datatable
        ...
        $('body').on('click', '.edit-post', function () {
            ...
            $.get('r-antibiotik/'+data_id + '/edit', function (data) {
                ...
                $('#id').val(data.id);
                $('#nama_antibiotik').val(data.nama_antibiotik);
                $('#jumlah').val(data.jumlah);
                $('#tanggal_awal').val(data.tanggal_awal);
                $('#tanggal_akhir').val(data.tanggal_akhir);
                $(`select#kategori_antibiotik_id option[value='${data.kategori_antibiotik_id}']`).prop('selected', true);
        ...
        $('#tombol-utama-hapus').click(function () {
            var url = "{{ route('master.antibiotik.r-antibiotik.destroy', ":dataId") }}";
            ...
            success: function (data) { //jika sukses
                setTimeout(function () {
                    ...
                    var oTable = $('#dt-antibiotik').dataTable();
                    oTable.fnDraw(false); //reset datatable
                });
