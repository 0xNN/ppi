@extends('layouts.app', ['title' => __('Asa Score')])

@section('content')
  @include('header.partials.header', [
      'title' => __('Asa Score'),
      'description' => __('Data Asa Score'),
      'class' => 'col-lg-12'
      ])

  @include('asa-score.admin.modal')
  <div class="container-fluid mt--7">
    <div class="row">
        <div class="col-xl-12 order-xl-1">
            <div class="card bg-secondary shadow">
                <div class="card-header bg-white border-0">
                    <div class="text-danger font-italic">{{ __('List Asa Score!') }}</div>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="dt-asa-score" class="table table-sm table-bordered dt-responsive nowrap" style="width:100%">
                            <thead class="thead-info">
                                <tr>
                                    <th>#</th>
                                    <th>ID</th>
                                    <th>Aksi</th>
                                    <th>Nama Asa Score</th>
                                    <th>Dibuat</th>
                                </tr>
                            </thead>
                            <tbody></tbody>
...
<script>
    ...
    $(document).ready(function() {
        var table = $('#dt-asa-score').DataTable({
            language: {
              language: {
            ...
            processing: true,
            serverSide: true,
            ajax: "{{ route('master.asa-score.r-asa-score.index') }}",
            columns: [
                {data: 'DT_RowIndex', name: 'DT_RowIndex'},
                {data: 'id', name: 'id'},
                {data: 'action', name: 'action', orderable: false, searchable: false},
                {data: 'nama_asa_score', name: 'nama_asa_score'},
            ...
            $("#form-tambah-edit").validate({
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        ...
                        url: "{{ route('master.asa-score.r-asa-score.store') }}", //url simpan data
                        ...
                        success: function (data) { //jika berhasil
                            ...
                            var oTable = $('#dt-asa-score').dataTable(); //inialisasi datatable
        ...
        $('body').on('click', '.edit-post', function () {
            ...
            $.get('r-asa-score/'+data_id + '/edit', function (data) {
                ...
                $('#id').val(data.id);
                $('#nama_asa_score').val(data.nama_asa_score);
            })
        });
        ...
        $('#tombol-utama-hapus').click(function () {
            var url = "{{ route('master.asa-score.r-asa-score.destroy', ":dataId") }}";
            ...
            success: function (data) { //jika sukses
                setTimeout(function () {
                    ...
                    var oTable = $('#dt-asa-score').dataTable();
                    oTable.fnDraw(false); //reset datatable
                });
