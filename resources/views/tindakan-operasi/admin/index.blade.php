@extends('layouts.app', ['title' => __('Tindakan Operasi')])

@section('content')
  @include('header.partials.header', [
      'title' => __('Tindakan Operasi'),
      'description' => __('Data Tindakan Operasi'),
      'class' => 'col-lg-12'
      ])

  @include('tindakan-operasi.admin.modal')
  <div class="container-fluid mt--7">
    <div class="row">
        <div class="col-xl-12 order-xl-1">
            <div class="card bg-secondary shadow">
                <div class="card-header bg-white border-0">
                    <div class="text-danger font-italic">{{ __('List Tindakan Operasi!') }}</div>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="dt-tindakan-operasi" class="table table-sm table-bordered dt-responsive nowrap" style="width:100%">
...
<script>
    ...
    $(document).ready(function() {
        var table = $('#dt-tindakan-operasi').DataTable({
            language: {
              language: {
            ...
            processing: true,
            serverSide: true,
            ajax: "{{ route('master.tindakan-operasi.r-tindakan-operasi.index') }}",
            columns: [
                {data: 'DT_RowIndex', name: 'DT_RowIndex'},
                {data: 'id', name: 'id'},
                {data: 'action', name: 'action', orderable: false, searchable: false},
                {data: 'nama_tindakan_operasi', name: 'nama_tindakan_operasi'},
            ...
            $("#form-tambah-edit").validate({
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        ...
                        url: "{{ route('master.tindakan-operasi.r-tindakan-operasi.store') }}", //url simpan data
                        ...
                        success: function (data) { //jika berhasil
                            ...
                            var oTable = $('#dt-tindakan-operasi').dataTable(); //inialisasi datatable
        ...
        $('body').on('click', '.edit-post', function () {
            ...
            $.get('r-tindakan-operasi/'+data_id + '/edit', function (data) {
                ...
                $('#id').val(data.id);
                $('#nama_tindakan_operasi').val(data.nama_tindakan_operasi);
            })
        });
        ...
        $('#tombol-utama-hapus').click(function () {
            var url = "{{ route('master.tindakan-operasi.r-tindakan-operasi.destroy', ":dataId") }}";
            ...
            success: function (data) { //jika sukses
                setTimeout(function () {
                    ...
                    var oTable = $('#dt-tindakan-operasi').dataTable();
                    oTable.fnDraw(false); //reset datatable
                });
