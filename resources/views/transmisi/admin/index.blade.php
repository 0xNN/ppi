@extends('layouts.app', ['title' => __('Transmisi')])

@section('content')
  @include('header.partials.header', [
      'title' => __('Transmisi'),
      'description' => __('Data Transmisi'),
      'class' => 'col-lg-12'
      ])

  @include('transmisi.admin.modal')
  <div class="container-fluid mt--7">
    <div class="row">
        <div class="col-xl-12 order-xl-1">
            <div class="card bg-secondary shadow">
                <div class="card-header bg-white border-0">
                    <div class="text-danger font-italic">{{ __('List Transmisi!') }}</div>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="dt-transmisi" class="table table-sm table-bordered dt-responsive nowrap" style="width:100%">
...
<script>
    ...
    $(document).ready(function() {
        var table = $('#dt-transmisi').DataTable({
            language: {
              language: {
            ...
            processing: true,
            serverSide: true,
            ajax: "{{ route('master.transmisi.r-transmisi.index') }}",
            columns: [
                {data: 'DT_RowIndex', name: 'DT_RowIndex'},
                {data: 'id', name: 'id'},
                {data: 'action', name: 'action', orderable: false, searchable: false},
                {data: 'nama_transmisi', name: 'nama_transmisi'},
            ...
            $("#form-tambah-edit").validate({
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        ...
                        url: "{{ route('master.transmisi.r-transmisi.store') }}", //url simpan data
                        ...
                        success: function (data) { //jika berhasil
                            ...
                            var oTable = $('#dt-transmisi').dataTable(); //inialisasi datatable
        ...
        $('body').on('click', '.edit-post', function () {
            ...
            $.get('r-transmisi/'+data_id + '/edit', function (data) {
                ...
                $('#id').val(data.id);
                $('#nama_transmisi').val(data.nama_transmisi);
            })
        });
        ...
        $('#tombol-utama-hapus').click(function () {
            var url = "{{ route('master.transmisi.r-transmisi.destroy', ":dataId") }}";
            ...
            success: function (data) { //jika sukses
                setTimeout(function () {
                    ...
                    var oTable = $('#dt-transmisi').dataTable();
                    oTable.fnDraw(false); //reset datatable
                });
