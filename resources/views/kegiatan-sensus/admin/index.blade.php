@extends('layouts.app', ['title' => __('Kegiatan Sensus')])

@section('content')
  @include('header.partials.header', [
      'title' => __('Kegiatan Sensus'),
      'description' => __('Data Kegiatan Sensus'),
      'class' => 'col-lg-12'
      ])

  @include('kegiatan-sensus.admin.modal')
  <div class="container-fluid mt--7">
    <div class="row">
        <div class="col-xl-12 order-xl-1">
            <div class="card bg-secondary shadow">
                <div class="card-header bg-white border-0">
                    <div class="text-danger font-italic">{{ __('List Kegiatan Sensus!') }}</div>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="dt-kegiatan-sensus" class="table table-sm table-bordered dt-responsive nowrap" style="width:100%">
                            <thead class="thead-info">
                                <tr>
                                    <th>#</th>
                                    <th>ID</th>
                                    <th>Aksi</th>
                                    <th>Kegiatan Sensus</th>
                                    <th>Dibuat</th>
                                </tr>
                            </thead>
                            <tbody></tbody>
...
<script>
    ...
    $(document).ready(function() {
        var table = $('#dt-kegiatan-sensus').DataTable({
            language: {
              language: {
            ...
            processing: true,
            serverSide: true,
            ajax: "{{ route('master.kegiatan-sensus.r-kegiatan-sensus.index') }}",
            columns: [
                {data: 'DT_RowIndex', name: 'DT_RowIndex'},
                {data: 'id', name: 'id'},
                {data: 'action', name: 'action', orderable: false, searchable: false},
                {data: 'nama_kegiatan_sensus', name: 'nama_kegiatan_sensus'},
            ...
            $("#form-tambah-edit").validate({
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        ...
                        url: "{{ route('master.kegiatan-sensus.r-kegiatan-sensus.store') }}", //url simpan data
                        ...
                        success: function (data) { //jika berhasil
                            ...
                            var oTable = $('#dt-kegiatan-sensus').dataTable(); //inialisasi datatable
        ...
        $('body').on('click', '.edit-post', function () {
            ...
            $.get('r-kegiatan-sensus/'+data_id + '/edit', function (data) {
                ...
                $('#id').val(data.id);
                $('#nama_kegiatan_sensus').val(data.nama_kegiatan_sensus);
            })
        });
        ...
        $('#tombol-utama-hapus').click(function () {
            var url = "{{ route('master.kegiatan-sensus.r-kegiatan-sensus.destroy', ":dataId") }}";
            ...
            success: function (data) { //jika sukses
                setTimeout(function () {
                    ...
                    var oTable = $('#dt-kegiatan-sensus').dataTable();
                    oTable.fnDraw(false); //reset datatable
                });
