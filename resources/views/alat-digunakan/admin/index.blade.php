@extends('layouts.app', ['title' => __('Alat Digunakan')])

@section('content')
  @include('header.partials.header', [
      'title' => __('Alat Digunakan'),
      'description' => __('Data alat yang digunakan'),
      'class' => 'col-lg-12'
      ])

  @include('alat-digunakan.admin.modal')
  <div class="container-fluid mt--7">
    <div class="row">
        <div class="col-xl-12 order-xl-1">
            <div class="card bg-secondary shadow">
                <div class="card-header bg-white border-0">
                    <div class="text-danger font-italic">{{ __('List Alat yang Digunakan!') }}</div>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="dt-alat-digunakan" class="table table-sm table-bordered dt-responsive nowrap" style="width:100%">
...
<script>
    ...
    $(document).ready(function() {
        var table = $('#dt-alat-digunakan').DataTable({
            language: {
              language: {
            ...
            processing: true,
            serverSide: true,
            ajax: "{{ route('master.alat-digunakan.r-alat-digunakan.index') }}",
            columns: [
                {data: 'DT_RowIndex', name: 'DT_RowIndex'},
                {data: 'id', name: 'id'},
                {data: 'action', name: 'action', orderable: false, searchable: false},
                {data: 'nama_alat_digunakan', name: 'nama_alat_digunakan'},
            ...
            $("#form-tambah-edit").validate({
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        ...
                        url: "{{ route('master.alat-digunakan.r-alat-digunakan.store') }}", //url simpan data
                        ...
                        success: function (data) { //jika berhasil
                            ...
                            var oTable = $('#dt-alat-digunakan').dataTable(); //inialisasi datatable
        ...
        $('body').on('click', '.edit-post', function () {
            ...
            $.get('r-alat-digunakan/'+data_id + '/edit', function (data) {
                ...
                $('#id').val(data.id);
                $('#nama_alat_digunakan').val(data.nama_alat_digunakan);
            })
        });
        ...
        $('#tombol-utama-hapus').click(function () {
            var url = "{{ route('master.alat-digunakan.r-alat-digunakan.destroy', ":dataId") }}";
            ...
            success: function (data) { //jika sukses
                setTimeout(function () {
                    ...
                    var oTable = $('#dt-alat-digunakan').dataTable();
                    oTable.fnDraw(false); //reset datatable
                });
